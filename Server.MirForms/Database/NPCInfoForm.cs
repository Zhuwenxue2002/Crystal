...
namespace Server
{
    public partial class NPCInfoForm : Form
    {
        ...
        private void RemoveButton_Click(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show("确定要移除选中的 NPC 吗？", "移除 NPC？", MessageBoxButtons.YesNo) != DialogResult.Yes) return;
        ...
        private void PasteMButton_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("无法粘贴，复制的数据不是 NPC 信息。");
                return;
            }
